...
public class ColonyNodeView extends JPanel
{
	...
	//public ArrayList<Ants> identifiersOfAntsInThisNode = new ArrayList<Ants> (10);
	public ArrayList<Ants> antsInThisNode = new ArrayList<Ants> (10);
	
	/*************
	 *	attributes
	 ************/
	
	//Number of foragers in a node
	int numForagers;
	
	//Number of scouts in a node
	int numScouts;
	
	//Number of soldiers in a node
	int numSoldiers;
	
	//Number of balas in a node
	int numBalas;
	
	//Number of total ants in a node
	int totalAnts;
	
	//Amount of food in a node
	int foodAmount;
	...
	/** get forager count */
	public int getForagerCount() { return numForagers; }

	/**
	 * set the number of scouts in each node
	 *	display the number of scouts in the node represented by this view
	 *
	 *	@param	numScouts		the number of scouts
	 */
	public void setScoutCount(int x)
	{
		numScouts = x;
		scoutLabel.setText("Sc: " + numScouts);
	}
	
	public int getScoutCount() { return numScouts; }
	...
	public int getSoldierCount() { return numSoldiers; }
	 ...
	 */
	public void setBalaCount(int x)
	{
		numBalas = x;
		balaLabel.setText("B: " + numBalas);
	}
	
	public int getBalaCount() { return numBalas; }
	
	/**
	 * Get total amount of ants (minus Balas) in a given node for determining if a Bala should attack
	 */
	public int getTotalAnts() {
		return numSoldiers + numScouts + numForagers;
	}
	 ...
	 */
	public void setPheromoneLevel(int x)
	{
		this.pheromone = x;
